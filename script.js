//1-Realizar estructura -ok
//2-Realizar distintos elementos -ok
//3-Realizar Responsive cada elemento -ok
//4-Alternativa a prompt
//5-Unir boton con select
...
// botonCrear.nodeValue = event.preventDefault();
